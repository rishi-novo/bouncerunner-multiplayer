...
// Normalized pixel ratio for consistent performance across devices
...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  className,
  style,
  antialias = false, // Default to false for better performance
  patternScale = 2,
  patternDensity = 1,
  liquid = false,
  liquidStrength = 0.1,
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const renderer = new THREE.WebGLRenderer({
        ...
        // Optimize for macOS by using lower precision
        precision: 'mediump'
      })
      ...
      const animate = (currentTime: number) => {
        ...
        // Frame rate limiting - skip frame if too fast (helps with 120Hz+ displays)
        ...
        // Use consistent time progression regardless of frame rate
        const timeFactor = deltaTime / targetFrameTime
      ...
      t.uniforms.uPixelSize.value = pixelSize * normalizedPixelRatio
